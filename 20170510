...
#Random Token ・A Strong, secure random token that does not have any data in it, and cannot be guessed. 
・This is equivalent to session id.

#Full Request Signature OAuth 
・Popularized by AWS authentication.

#OAuth ・Only Use this when you have three parties - You, Your users and third party app developers that need your user data. 
